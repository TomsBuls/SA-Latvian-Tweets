...
Link to GitHub: https://github.com/TomsBuls/SA-Latvian-Tweets
Link to Google Drive: 
(The model files are large in size. Therefore, a link to a GitHub repository and Google Drive is provided. Also, the models using random oversampling (ROS) technique are supplied in the artefact as this would double the size of the artefact.)
